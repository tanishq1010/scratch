...
class Source(object):
    ...
    def main(self, atg_id, difficulty, duration, exam_code, name, request_id):
        ...
        response1 = API_call("https://fiberdemoms-cdn.embibe.com/fiber_ms/v1/atg/progress",payload, "POST",'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJyb2xlIjoic3R1ZGVudCIsInRpbWVfc3RhbXAiOiIyMDIwLTExLTE3IDExOjM3OjM0IFVUQyIsImlzX2d1ZXN0IjpmYWxzZSwiaWQiOjM3MjE0MDQsImVtYWlsIjoiMzYxNTU5NF8xNjAyNzgzNzQ2QGVtYmliZS11c2VyLmNvbSJ9.xAKYAszvYPOTEWHzdTbfSROvr-mi5yxK28EpFceaWCvfYhMaawTce2vTMlaIGRTi48tLhzvQ__CgUgeN79vdnQ',0)
    ...
    for ind in df.index:
        ...
        if df["Atg_id"][ind] == "ATG API FAILED" or df["Atg_id"][ind]=="EXAM CONFIG FAILED/EXAM CONFIGURATION FAILED":
            ...
            df.to_csv('Create_test_data.csv', index=False)
                ...
                success, progress = src.main(df['Atg_id'][ind], df['Difficulty'][ind], df['Time'][ind], df['Exam_code'][ind],
