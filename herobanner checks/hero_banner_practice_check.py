...
def subject_data(child_id, board, grade, exam, goal, embibe_token, subject, df, host):
    ...
    if flag == 0:
        df.loc[len(df)] = [f'Practice/home/{subject}', goal, exam, 'PRACTICE BANNER NOT PRESENT', 'Na', subject,
                           'Na', 'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na']
...
def home_data(child_id, board, grade, exam, goal, embibe_token, host):
    ...
    try:
        ...
        if flag == 0:
            df.loc[len(df)] = ['Practice/home', goal, exam, 'PRACTICE BANNER NOT PRESENT', 'Na', 'All Subjects',
                               'Na', 'Na', 'Na', 'Na', 'Na', 'Na',
                               'Na', 'Na', 'Na', 'Na', 'Na',
                               'Na', 'Na', 'Na', 'Na']
        ...
        print(e)
        df.loc[len(df)] = ['Practice/home', goal, exam, response1.text, 'Na', 'All Subjects',
                           'Na', 'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na']
