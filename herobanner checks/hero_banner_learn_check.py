            ...
            if item["content_section_type"] == "HEROBANNER":
                ...
                for item in item['content']:
                    for item in item['data']:
                        ...
                        df.loc[len(df)] = [f"Learn/home/{subject}", goal, exam, tagged_exam, tagged_exam_correct,
                                           subject,
                                           subject_tagged, is_subject_tagged_correct, ID, duration_in_cg,
                                           duration_display,
                                           expected_duration_display, is_duration_okay, embium_coins, title,
                                           description,
                                           image_url, video_url, teaser_url, status, title1, description1, learnpath1]

        # print(df)
        if flag == 0:
            df.loc[len(df)] = [f'Learn/home/{subject}', goal, exam, 'HEROBANNER NOT FOUND', 'Na', 'All Subjects',
                               subject, 'Na', 'Na', 'Na', 'Na',
                               'Na', 'Na', 'Na', 'Na', 'Na',
                               'Na', 'Na', 'Na', 'Na', 'Na', 'Na', 'Na']
    except Exception as e:
        print(e)
        df.loc[len(df)] = [f'Learn/home/{subject}', goal, exam, response1.text, 'Na', 'All Subjects',
                           subject, 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na', 'Na', 'Na', 'Na']
...
def home_data(child_id, board, grade, exam, goal, embibe_token, host):
    ...
    try:
        ...
        if flag == 0:
            if flag == 0:
                df.loc[len(df)] = ['Learn/home', goal, exam, 'HEROBANNER NOT FOUND', 'Na', 'All Subjects',
                                   'Na', 'Na', 'Na', 'Na', 'Na',
                                   'Na', 'Na', 'Na', 'Na', 'Na',
                                   'Na', 'Na', 'Na', 'Na', 'Na', 'Na', 'Na']
        ...
        print(e)
        df.loc[len(df)] = ['Learn/home', goal, exam, response1.text, 'Na', 'All Subjects',
                           'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na', 'Na',
                           'Na', 'Na', 'Na', 'Na', 'Na', 'Na', 'Na']
        df.to_csv('Herobanner_check.csv',index=False)
