...
class Source(object):
    ...
    def main(self, df):
        ...
        for ind in df.index:
            ...
            response_status_code4=response4.status_code
            response_body=response4.text
            try:
                print("all tests :", response4.status_code)
                if response4.status_code == 200 and json.loads(response4.text)!=[]:
                    test = True
                else:
                    test = False
            ...
            response_status_code5=response5.status_code
            try:
